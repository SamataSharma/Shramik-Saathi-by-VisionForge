...
export async function renderCertificateView(container, state) {
  ...
  const qrSvg = renderQRCodeSVG(verifyUrl, 120);
    ...
    <div style="padding-top: 8px;">
      ...
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
        ...
        <div style="display: flex; gap: 8px;">
          <a href="#verify/${certId}" class="btn-secondary" style="padding: 6px 14px; font-size: 12px; text-decoration: none; display: flex; align-items: center; gap: 4px;">
            🔍 ${t('verify_certificate', 'Verify Online')}
          </a>
      ...
      <div class="certificate-frame">
        ...
        <!-- QR Code & Cryptographic Verification Reference -->
        <div style="margin: 16px 0; text-align: center;">
          <div class="cert-qr-box" style="cursor: pointer; display: inline-block;" id="btn-qr-link" title="Click or Scan to Verify">
            ${qrSvg}
          </div>
          <div style="font-family: monospace; font-size: 11px; font-weight: 800; color: #0f172a; margin-top: 6px;">
            VERIFY ID: ${certId}
          </div>
          <div style="margin-top: 3px;">
            <a href="#verify/${certId}" style="font-size: 11px; color: #0284c7; text-decoration: underline; font-weight: 700;">
              🔍 ${t('verify_certificate', 'Verify Statutory Certificate Online')} ➔
            </a>
          </div>
        </div>
  ...
  container.querySelector('#btn-qr-link')?.addEventListener('click', () => {
