...
const LESSON_PARTS = [
  {
    id: "part_1",
    partNumber: 1,
    title: "Conveyor Friction & Early Smoke Recognition",
    videoUrl: "/assets/videos/fire_safety_part1.mp4",
    durationStr: "00:21",
    durationSec: 21,
    startTimeSec: 0,
    summary: "Authentic footage demonstrating spontaneous conveyor heating, friction hot-spots, and sensory smoke awareness in underground coal mine galleries.",
    keyPoints: [
      "Coal fines absorb atmospheric oxygen leading to exothermic reaction",
      "Early heating detection prevents catastrophic conveyor belt fires",
      "Notice faint grey haze and distinct paraffin-like odor near idler rollers",
    ...
    options: [
      ...
      { text: "Sweet paraffin-like odor and localized haze", correct: true, reason: "Correct! The low-temperature oxidation of coal volatiles emits a distinct odor first." },
  ...
  },
  {
    id: "part_2",
    partNumber: 2,
    title: "PASS Technique & Extinguisher Field Execution",
    videoUrl: "/assets/videos/fire_safety_part2.mp4",
    durationStr: "01:17",
    durationSec: 77,
    startTimeSec: 0,
    summary: "Operational demonstration of manual Dry Chemical Powder (DCP) cylinder inspection and the 4-step PASS suppression sequence.",
    keyPoints: [
      "P - Pull the safety lock pin firmly to release lever",
      "A - Aim the discharge nozzle directly at the base of burning coal",
      "S - Squeeze operating lever smoothly and continuously",
      "S - Sweep nozzle horizontally side-to-side across the coal friction bed"
    ],
    question: "Where should the extinguisher nozzle be aimed during discharge?",
    options: [
      ...
      { text: "Directly at the base of the burning fuel", correct: true, reason: "Correct! Smothering the fuel base cuts off oxygen and knocks down combustion." },
      { text: "Upward toward mine roof bolts", correct: false, reason: "Aiming at the roof has zero effect on the floor/belt fire." }
    ]
  }
];
